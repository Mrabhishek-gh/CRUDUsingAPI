...
{
    public class Version2ApiController : ApiController
    {
        ...
        public IHttpActionResult DeleteCustomer(int id)
        {
            ...
            {
                var responce = Request.CreateErrorResponse(HttpStatusCode.NotFound, "Data cannot be deleted due to invalid id");
                return ResponseMessage(responce);
            }
        }
    }
