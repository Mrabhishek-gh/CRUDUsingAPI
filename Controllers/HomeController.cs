...
namespace WebApiAssignment1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            try
            {
                var consumeData = await client.GetAsync("Api/Customer");
        ...
        public async Task<ActionResult> InsertCust(Customer customer)
        {
            ...
            HttpResponseMessage consumeData = await client.PostAsync("Api/Customer", content);
        ...
        public async Task<ActionResult> UpdateCust(Customer customer)
        {
            ...
            HttpResponseMessage consumeData = await httpClient.PutAsync("Api/Customer", content);
        ...
        public async Task<ActionResult> DeleteCust(int id)
        {
            HttpClient httpClient = new HttpClient();
            httpClient.BaseAddress = new Uri("http://localhost:61680/");
            HttpResponseMessage consumeData = await httpClient.DeleteAsync($"Api/Customer/{id}");
